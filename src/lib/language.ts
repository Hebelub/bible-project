...
// Norwegian text for Ruth
export const ruthNorwegian = {
  title: "Ruts bok",
  chapter1: {
    title: "Elimeleks familie drar til Moab",
    verses: {
      ...
      2: "Mannens navn var Elimelek, hans kone hadde navnet No'omi, og navnene på hans to sønner var Mahlon og Kiljon. De var efratitter fra Betlehem i Juda. Og de dro til landet Moab og ble der.",
      ...
      5: "Så døde også begge de, både Mahlon og Kiljon. Slik overlevde kvinnen både sine to sønner og sin mann.",
      ...
      15: "Og No'omi sa: «Se, din svigerinne har dratt tilbake til sitt folk og til sine guder. Vend også du tilbake og følg din svigerinne!»",
  ...
  chapter2: {
    ...
    verses: {
      ...
      14: "Da tiden for måltidet var kommet, sa Boas til henne: «Kom hit og spis av brødet og dypp brødbiten din i vineddiken!» Så satte hun seg ved siden av høstarbeiderne, og han sendte bort tørket korn til henne. Hun spiste seg mett og hadde noe til overs.",
      ...
      18: "Så tok hun det og gikk inn i byen, og hennes svigermor fikk se hva hun hadde samlet. Hun tok da fram og ga No'omi det hun hadde til overs etter at hun selv var blitt mett.",
      19: "Hennes svigermor sa til henne: «Hvor har du sanket i dag? Og hvor har du arbeidet? Velsignet være den som tok seg av deg.» Så fortalte hun sin svigermor hvem hun hadde arbeidet hos, og sa: «Mannen jeg arbeidet hos i dag, heter Boas.»",
      20: "Da sa No'omi til sin svigerdatter: «Velsignet være han av Herren, Han som ikke har holdt sin barmhjertighet tilbake verken fra de levende eller de døde!» No'omi sa til henne: «Denne mannen er en slektning av oss, en av våre løsere.»",
  ...
  chapter3: {
    title: "Det sikres at Rut blir løst ut",
    verses: {
  ...
  chapter4: {
    ...
    verses: {
      ...
      8: "Derfor sa løseren til Boaz: «Kjøp den selv!» Så tok han av seg sandalen.",
...
// English text for Ruth (your existing text)
export const ruthEnglish = {
  title: "Book of Ruth",
  chapter1: {
    title: "Elimelech's Family Goes to Moab",
    verses: {
  ...
  chapter2: {
    ...
    verses: {
      ...
      19: "Her mother-in-law asked her, 'Where did you glean today? Where did you work? Blessed be the man who took notice of you!' Then Ruth told her mother-in-law about the one at whose place she had worked. 'The name of the man I worked with today is Boaz,' she said.",
...
export function getRuthText(language: Language) {
  return language === 'no' ? ruthNorwegian : ruthEnglish;
}
